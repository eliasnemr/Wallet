...
exports.ContactsPageModule = void 0;
...
var contacts_page_1 = require("./contacts.page");
var routes = [
    {
        path: '',
        component: contacts_page_1.ContactsPage
    },
];
var ContactsPageModule = /** @class */ (function () {
    ...
    ContactsPageModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [contacts_page_1.ContactsPage]
        })
        /** */
    ], ContactsPageModule);
    return ContactsPageModule;
}());
exports.ContactsPageModule = ContactsPageModule;
