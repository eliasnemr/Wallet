...
__webpack_require__(/*! /Users/eliasnemr/projects/CoinMasterPro/CoinMasterPro/node_modules/webpack-dev-server/client/index.js?http://0.0.0.0:0&sockPath=/sockjs-node */"QM51");
module.exports = __webpack_require__(/*! /Users/eliasnemr/projects/CoinMasterPro/CoinMasterPro/src/main.ts */"zUnb");
...
let ApiService = class ApiService {
    ...
    getCoinsForToken(tokenid) {
        return this.req('coinsimple "' + tokenid + '"');
    }
    req(fnc) {
        return new Promise((resolve, reject) => {
            minima__WEBPACK_IMPORTED_MODULE_2__["Minima"].cmd(fnc, (res) => {
                if (res.status) {
                    resolve(res);
                }
                else {
...
let AppComponent = class AppComponent {
    ...
    initMinima() {
        minima__WEBPACK_IMPORTED_MODULE_5__["Minima"].init((msg) => {
            if (msg.event === 'connected') {
                this.api.set$Balance(minima__WEBPACK_IMPORTED_MODULE_5__["Minima"].balance);
            }
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["AppRoutingModule"]],
        providers: [
