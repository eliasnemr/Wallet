...
@implementation OrgMinimaMiniscriptFunctionsTxnPREVSTATE

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgMinimaMiniscriptFunctionsTxnPREVSTATE_init(self);
  return self;
}
...
- (OrgMinimaMiniscriptFunctionsMinimaFunction *)getNewFunction {
  return create_OrgMinimaMiniscriptFunctionsTxnPREVSTATE_init();
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgMinimaMiniscriptFunctionsTxnPREVSTATE = { "PREVSTATE", "org.minima.miniscript.functions.txn", ptrTable, methods, NULL, 7, 0x1, 3, 0, -1, -1, -1, -1, -1 };
  return &_OrgMinimaMiniscriptFunctionsTxnPREVSTATE;
}

@end

void OrgMinimaMiniscriptFunctionsTxnPREVSTATE_init(OrgMinimaMiniscriptFunctionsTxnPREVSTATE *self) {
  OrgMinimaMiniscriptFunctionsMinimaFunction_initWithNSString_(self, @"PREVSTATE");
}

OrgMinimaMiniscriptFunctionsTxnPREVSTATE *new_OrgMinimaMiniscriptFunctionsTxnPREVSTATE_init() {
  J2OBJC_NEW_IMPL(OrgMinimaMiniscriptFunctionsTxnPREVSTATE, init)
}

OrgMinimaMiniscriptFunctionsTxnPREVSTATE *create_OrgMinimaMiniscriptFunctionsTxnPREVSTATE_init() {
  J2OBJC_CREATE_IMPL(OrgMinimaMiniscriptFunctionsTxnPREVSTATE, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgMinimaMiniscriptFunctionsTxnPREVSTATE)
