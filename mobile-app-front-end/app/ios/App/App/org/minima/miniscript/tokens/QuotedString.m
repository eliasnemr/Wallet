...
@interface OrgMinimaMiniscriptTokensQuotedString ()

- (jint)findFinalQuoteWithInt:(jint)zCurrentPos;

@end

__attribute__((unused)) static jint OrgMinimaMiniscriptTokensQuotedString_findFinalQuoteWithInt_(OrgMinimaMiniscriptTokensQuotedString *self, jint zCurrentPos);

@implementation OrgMinimaMiniscriptTokensQuotedString

- (instancetype)initWithNSString:(NSString *)zString {
  OrgMinimaMiniscriptTokensQuotedString_initWithNSString_(self, zString);
  return self;
}
...
- (NSString *)getDeQuotedString {
  ...
  while (mCurrentPos_ < len) {
    ...
    if ([((NSString *) nil_chk(next)) isEqual:@"["]) {
      ...
      jint end = OrgMinimaMiniscriptTokensQuotedString_findFinalQuoteWithInt_(self, mCurrentPos_ + 1);
...
- (jint)findFinalQuoteWithInt:(jint)zCurrentPos {
  return OrgMinimaMiniscriptTokensQuotedString_findFinalQuoteWithInt_(self, zCurrentPos);
}
...
+ (void)mainWithNSStringArray:(IOSObjectArray *)zArgs {
  OrgMinimaMiniscriptTokensQuotedString_mainWithNSStringArray_(zArgs);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgMinimaMiniscriptTokensQuotedString = { "QuotedString", "org.minima.miniscript.tokens", ptrTable, methods, fields, 7, 0x1, 6, 5, -1, -1, -1, -1, -1 };
  return &_OrgMinimaMiniscriptTokensQuotedString;
}

@end

void OrgMinimaMiniscriptTokensQuotedString_initWithNSString_(OrgMinimaMiniscriptTokensQuotedString *self, NSString *zString) {
  NSObject_init(self);
  JreStrongAssign(&self->mString_, zString);
  JreStrongAssignAndConsume(&self->mQuotes_, new_JavaUtilArrayList_init());
}

OrgMinimaMiniscriptTokensQuotedString *new_OrgMinimaMiniscriptTokensQuotedString_initWithNSString_(NSString *zString) {
  J2OBJC_NEW_IMPL(OrgMinimaMiniscriptTokensQuotedString, initWithNSString_, zString)
}

OrgMinimaMiniscriptTokensQuotedString *create_OrgMinimaMiniscriptTokensQuotedString_initWithNSString_(NSString *zString) {
  J2OBJC_CREATE_IMPL(OrgMinimaMiniscriptTokensQuotedString, initWithNSString_, zString)
}

jint OrgMinimaMiniscriptTokensQuotedString_findFinalQuoteWithInt_(OrgMinimaMiniscriptTokensQuotedString *self, jint zCurrentPos) {
  ...
  while (pos < len) {
    ...
    if ([((NSString *) nil_chk(next)) isEqual:@"["]) {
      pos = OrgMinimaMiniscriptTokensQuotedString_findFinalQuoteWithInt_(self, pos + 1);
    }
...
void OrgMinimaMiniscriptTokensQuotedString_mainWithNSStringArray_(IOSObjectArray *zArgs) {
  OrgMinimaMiniscriptTokensQuotedString_initialize();
  ...
  tester = OrgMinimaMiniscriptContract_cleanScriptWithNSString_(tester);
  [((JavaIoPrintStream *) nil_chk(JreLoadStatic(JavaLangSystem, out))) printlnWithNSString:JreStrcat("$$", @"Clean : ", tester)];
  OrgMinimaMiniscriptTokensQuotedString *qs = create_OrgMinimaMiniscriptTokensQuotedString_initWithNSString_(tester);
  [((JavaIoPrintStream *) nil_chk(JreLoadStatic(JavaLangSystem, out))) printlnWithNSString:JreStrcat("$$", @"String : ", tester)];
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgMinimaMiniscriptTokensQuotedString)
