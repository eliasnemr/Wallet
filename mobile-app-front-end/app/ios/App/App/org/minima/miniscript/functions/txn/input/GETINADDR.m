...
#include "org/minima/miniscript/functions/txn/input/GETINADDR.h"
...
- (instancetype)init {
  OrgMinimaMiniscriptFunctionsTxnInputGETINADDR_init(self);
  return self;
}
...
- (OrgMinimaMiniscriptFunctionsMinimaFunction *)getNewFunction {
  return create_OrgMinimaMiniscriptFunctionsTxnInputGETINADDR_init();
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgMinimaMiniscriptFunctionsTxnInputGETINADDR = { "GETINADDR", "org.minima.miniscript.functions.txn.input", ptrTable, methods, NULL, 7, 0x1, 3, 0, -1, -1, -1, -1, -1 };
  return &_OrgMinimaMiniscriptFunctionsTxnInputGETINADDR;
}

@end

void OrgMinimaMiniscriptFunctionsTxnInputGETINADDR_init(OrgMinimaMiniscriptFunctionsTxnInputGETINADDR *self) {
  OrgMinimaMiniscriptFunctionsMinimaFunction_initWithNSString_(self, @"GETINADDR");
}

OrgMinimaMiniscriptFunctionsTxnInputGETINADDR *new_OrgMinimaMiniscriptFunctionsTxnInputGETINADDR_init() {
  J2OBJC_NEW_IMPL(OrgMinimaMiniscriptFunctionsTxnInputGETINADDR, init)
}

OrgMinimaMiniscriptFunctionsTxnInputGETINADDR *create_OrgMinimaMiniscriptFunctionsTxnInputGETINADDR_init() {
  J2OBJC_CREATE_IMPL(OrgMinimaMiniscriptFunctionsTxnInputGETINADDR, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgMinimaMiniscriptFunctionsTxnInputGETINADDR)
