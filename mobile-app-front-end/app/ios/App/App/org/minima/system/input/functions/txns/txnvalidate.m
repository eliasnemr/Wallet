...
@implementation OrgMinimaSystemInputFunctionsTxnstxnvalidate

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgMinimaSystemInputFunctionsTxnstxnvalidate_init(self);
  return self;
}
...
- (void)doFunctionWithNSStringArray:(IOSObjectArray *)zInput {
  ...
  OrgMinimaUtilsMessagesMessage *msg = create_OrgMinimaUtilsMessagesMessage_initWithNSString_(OrgMinimaSystemBrainsConsensusTxn_CONSENSUS_TXNVALIDATE);
...
- (OrgMinimaSystemInputCommandFunction *)getNewFunction {
  return create_OrgMinimaSystemInputFunctionsTxnstxnvalidate_init();
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgMinimaSystemInputFunctionsTxnstxnvalidate = { "txnvalidate", "org.minima.system.input.functions.txns", ptrTable, methods, NULL, 7, 0x1, 3, 0, -1, -1, -1, -1, -1 };
  return &_OrgMinimaSystemInputFunctionsTxnstxnvalidate;
}
...
OrgMinimaSystemInputFunctionsTxnstxnvalidate *new_OrgMinimaSystemInputFunctionsTxnstxnvalidate_init() {
  J2OBJC_NEW_IMPL(OrgMinimaSystemInputFunctionsTxnstxnvalidate, init)
}

OrgMinimaSystemInputFunctionsTxnstxnvalidate *create_OrgMinimaSystemInputFunctionsTxnstxnvalidate_init() {
  J2OBJC_CREATE_IMPL(OrgMinimaSystemInputFunctionsTxnstxnvalidate, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgMinimaSystemInputFunctionsTxnstxnvalidate)

J2OBJC_NAME_MAPPING(OrgMinimaSystemInputFunctionsTxnstxnvalidate, "org.minima.system.input.functions.txns", "OrgMinimaSystemInputFunctionsTxns")
