...
OrgMinimaObjectsBaseMiniData32 *OrgMinimaSystemInputFunctionsgimme50_COINID_INPUT;
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "COINID_INPUT", "LOrgMinimaObjectsBaseMiniData32;", .constantValue.asLong = 0, 0x9, -1, 3, -1, -1 },
  };
...
+ (void)initialize {
  if (self == [OrgMinimaSystemInputFunctionsgimme50 class]) {
    JreStrongAssignAndConsume(&OrgMinimaSystemInputFunctionsgimme50_COINID_INPUT, new_OrgMinimaObjectsBaseMiniData32_initWithNSString_(@"0xFEED50FEED50FEED50FEED50"));
