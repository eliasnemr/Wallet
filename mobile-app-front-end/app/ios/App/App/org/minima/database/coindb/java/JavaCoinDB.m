...
- (JavaUtilArrayList *)checkForRelevantCoinsWithOrgMinimaObjectsBaseMiniData32:(OrgMinimaObjectsBaseMiniData32 *)zAddress {
  ...
  for (id<OrgMinimaDatabaseCoindbCoinDBRow> __strong row in nil_chk(mRows_)) {
    if ([((OrgMinimaObjectsBaseMiniData32 *) nil_chk([((OrgMinimaObjectsCoin *) nil_chk([((id<OrgMinimaDatabaseCoindbCoinDBRow>) nil_chk(row)) getCoin])) getAddress])) isExactlyEqualWithOrgMinimaObjectsBaseMiniData:zAddress]) {
      [ret addWithId:row];
    }
  }
  return ret;
...
- (id<OrgMinimaDatabaseCoindbCoinDBRow>)getCoinRowWithOrgMinimaObjectsBaseMiniData32:(OrgMinimaObjectsBaseMiniData32 *)zCoinID {
  for (id<OrgMinimaDatabaseCoindbCoinDBRow> __strong row in nil_chk(mRows_)) {
    if ([((OrgMinimaObjectsBaseMiniData32 *) nil_chk([((OrgMinimaObjectsCoin *) nil_chk([((id<OrgMinimaDatabaseCoindbCoinDBRow>) nil_chk(row)) getCoin])) getCoinID])) isNumericallyEqualWithOrgMinimaObjectsBaseMiniData:zCoinID]) {
      return row;
    }
  }
  return nil;
...
- (id<OrgMinimaDatabaseCoindbCoinDBRow>)addCoinRowWithOrgMinimaObjectsCoin:(OrgMinimaObjectsCoin *)zCoin {
  id<OrgMinimaDatabaseCoindbCoinDBRow> row = [self getCoinRowWithOrgMinimaObjectsBaseMiniData32:[((OrgMinimaObjectsCoin *) nil_chk(zCoin)) getCoinID]];
  if (row != nil) {
    return row;
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[3].selector = @selector(checkForRelevantCoinsWithOrgMinimaObjectsBaseMiniData32:);
  methods[4].selector = @selector(getCoinRowWithOrgMinimaObjectsBaseMiniData32:);
  ...
  static const void *ptrTable[] = { "()Ljava/util/ArrayList<Lorg/minima/database/coindb/CoinDBRow;>;", "checkForRelevantCoins", "LOrgMinimaObjectsBaseMiniData32;", "(Lorg/minima/objects/base/MiniData32;)Ljava/util/ArrayList<Lorg/minima/database/coindb/CoinDBRow;>;", "getCoinRow", "addCoinRow", "LOrgMinimaObjectsCoin;", "removeOldSpentCoins", "LOrgMinimaObjectsBaseMiniNumber;", &OrgMinimaDatabaseCoindbJavaJavaCoinDB_COINDB_LIMIT, "Ljava/util/ArrayList<Lorg/minima/database/coindb/CoinDBRow;>;" };
