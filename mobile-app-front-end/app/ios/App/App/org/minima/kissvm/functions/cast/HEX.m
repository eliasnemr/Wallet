...
@implementation OrgMinimaKissvmFunctionsCastHEX

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgMinimaKissvmFunctionsCastHEX_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgMinimaKissvmFunctionsCastHEX = { "HEX", "org.minima.kissvm.functions.cast", ptrTable, methods, NULL, 7, 0x1, 3, 0, -1, -1, -1, -1, -1 };
  return &_OrgMinimaKissvmFunctionsCastHEX;
}

@end

void OrgMinimaKissvmFunctionsCastHEX_init(OrgMinimaKissvmFunctionsCastHEX *self) {
  OrgMinimaKissvmFunctionsMinimaFunction_initWithNSString_(self, @"HEX");
}

OrgMinimaKissvmFunctionsCastHEX *new_OrgMinimaKissvmFunctionsCastHEX_init() {
  J2OBJC_NEW_IMPL(OrgMinimaKissvmFunctionsCastHEX, init)
}

OrgMinimaKissvmFunctionsCastHEX *create_OrgMinimaKissvmFunctionsCastHEX_init() {
  J2OBJC_CREATE_IMPL(OrgMinimaKissvmFunctionsCastHEX, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgMinimaKissvmFunctionsCastHEX)
