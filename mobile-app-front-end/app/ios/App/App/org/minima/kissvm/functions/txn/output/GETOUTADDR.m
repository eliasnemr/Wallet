...
@implementation OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR_init(self);
  return self;
}
...
- (OrgMinimaKissvmValuesValue *)runFunctionWithOrgMinimaKissvmContract:(OrgMinimaKissvmContract *)zContract {
  ...
  if ([((JavaUtilArrayList *) nil_chk(outs)) size] <= output) {
    @throw new_OrgMinimaKissvmExceptionsExecutionException_initWithNSString_(JreStrcat("$ICI", @"Output number too high ", output, '/', [outs size]));
  }
  OrgMinimaObjectsCoin *cc = [outs getWithInt:output];
  return new_OrgMinimaKissvmValuesHEXValue_initWithOrgMinimaObjectsBaseMiniData_([((OrgMinimaObjectsCoin *) nil_chk(cc)) getAddress]);
}

- (OrgMinimaKissvmFunctionsMinimaFunction *)getNewFunction {
  return new_OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR_init();
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR = { "GETOUTADDR", "org.minima.kissvm.functions.txn.output", ptrTable, methods, NULL, 7, 0x1, 3, 0, -1, -1, -1, -1, -1 };
  return &_OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR;
}

@end

void OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR_init(OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR *self) {
  OrgMinimaKissvmFunctionsMinimaFunction_initWithNSString_(self, @"GETOUTADDR");
}

OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR *new_OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR_init() {
  J2OBJC_NEW_IMPL(OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR, init)
}

OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR *create_OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR_init() {
  J2OBJC_CREATE_IMPL(OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgMinimaKissvmFunctionsTxnOutputGETOUTADDR)
