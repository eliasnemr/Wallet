...
#include "org/minima/kissvm/functions/txn/input/GETINADDR.h"
...
@implementation OrgMinimaKissvmFunctionsTxnInputGETINADDR

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgMinimaKissvmFunctionsTxnInputGETINADDR_init(self);
  return self;
}
...
- (OrgMinimaKissvmValuesValue *)runFunctionWithOrgMinimaKissvmContract:(OrgMinimaKissvmContract *)zContract {
  ...
  return create_OrgMinimaKissvmValuesHEXValue_initWithOrgMinimaObjectsBaseMiniData_([((OrgMinimaObjectsCoin *) nil_chk(cc)) getAddress]);
}

- (OrgMinimaKissvmFunctionsMinimaFunction *)getNewFunction {
  return create_OrgMinimaKissvmFunctionsTxnInputGETINADDR_init();
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgMinimaKissvmFunctionsTxnInputGETINADDR = { "GETINADDR", "org.minima.kissvm.functions.txn.input", ptrTable, methods, NULL, 7, 0x1, 3, 0, -1, -1, -1, -1, -1 };
  return &_OrgMinimaKissvmFunctionsTxnInputGETINADDR;
}

@end

void OrgMinimaKissvmFunctionsTxnInputGETINADDR_init(OrgMinimaKissvmFunctionsTxnInputGETINADDR *self) {
  OrgMinimaKissvmFunctionsMinimaFunction_initWithNSString_(self, @"GETINADDR");
}

OrgMinimaKissvmFunctionsTxnInputGETINADDR *new_OrgMinimaKissvmFunctionsTxnInputGETINADDR_init() {
  J2OBJC_NEW_IMPL(OrgMinimaKissvmFunctionsTxnInputGETINADDR, init)
}

OrgMinimaKissvmFunctionsTxnInputGETINADDR *create_OrgMinimaKissvmFunctionsTxnInputGETINADDR_init() {
  J2OBJC_CREATE_IMPL(OrgMinimaKissvmFunctionsTxnInputGETINADDR, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgMinimaKissvmFunctionsTxnInputGETINADDR)
