...
@interface OrgMinimaKissvmTokensToken () {
 @public
  jint mTokenType_;
  NSString *mToken_;
}
...
J2OBJC_FIELD_SETTER(OrgMinimaKissvmTokensToken, mToken_, NSString *)

J2OBJC_INITIALIZED_DEFN(OrgMinimaKissvmTokensToken)

IOSObjectArray *OrgMinimaKissvmTokensToken_TOKENS_COMMAND;
IOSObjectArray *OrgMinimaKissvmTokensToken_TOKENS_OPERATOR;

@implementation OrgMinimaKissvmTokensToken

- (instancetype)initWithInt:(jint)zTokenType
               withNSString:(NSString *)zToken {
  OrgMinimaKissvmTokensToken_initWithInt_withNSString_(self, zTokenType, zToken);
  return self;
}
...
- (NSString *)getTokenTypeString {
  switch (mTokenType_) {
    case OrgMinimaKissvmTokensToken_TOKEN_CLOSEBRACKET:
    return @"CLOSEBRACKET";
    case OrgMinimaKissvmTokensToken_TOKEN_COMMAND:
    return @"COMMAND";
    case OrgMinimaKissvmTokensToken_TOKEN_TRUE:
    return @"TRUE";
    case OrgMinimaKissvmTokensToken_TOKEN_FALSE:
    return @"FALSE";
    case OrgMinimaKissvmTokensToken_TOKEN_FUNCTIION:
    return @"FUNCTION";
    case OrgMinimaKissvmTokensToken_TOKEN_VALUE:
    return @"VALUE";
    case OrgMinimaKissvmTokensToken_TOKEN_OPENBRACKET:
    return @"OPENBRACKET";
    case OrgMinimaKissvmTokensToken_TOKEN_OPERATOR:
    return @"OPERATOR";
    case OrgMinimaKissvmTokensToken_TOKEN_VARIABLE:
    return @"VARIABLE";
    case OrgMinimaKissvmTokensToken_TOKEN_GLOBAL:
    return @"GLOBAL";
    default:
    break;
  }
...
+ (jboolean)isNumericWithNSString:(NSString *)str {
  return OrgMinimaKissvmTokensToken_isNumericWithNSString_(str);
}

+ (jboolean)isVariableWithNSString:(NSString *)str {
  return OrgMinimaKissvmTokensToken_isVariableWithNSString_(str);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "TOKEN_COMMAND", "I", .constantValue.asInt = OrgMinimaKissvmTokensToken_TOKEN_COMMAND, 0x19, -1, -1, -1, -1 },
    { "TOKENS_COMMAND", "[LNSString;", .constantValue.asLong = 0, 0x19, -1, 9, -1, -1 },
    { "TOKEN_FUNCTIION", "I", .constantValue.asInt = OrgMinimaKissvmTokensToken_TOKEN_FUNCTIION, 0x19, -1, -1, -1, -1 },
    { "TOKEN_OPERATOR", "I", .constantValue.asInt = OrgMinimaKissvmTokensToken_TOKEN_OPERATOR, 0x19, -1, -1, -1, -1 },
    { "TOKENS_OPERATOR", "[LNSString;", .constantValue.asLong = 0, 0x19, -1, 10, -1, -1 },
    { "TOKEN_VALUE", "I", .constantValue.asInt = OrgMinimaKissvmTokensToken_TOKEN_VALUE, 0x19, -1, -1, -1, -1 },
    { "TOKEN_VARIABLE", "I", .constantValue.asInt = OrgMinimaKissvmTokensToken_TOKEN_VARIABLE, 0x19, -1, -1, -1, -1 },
    { "TOKEN_GLOBAL", "I", .constantValue.asInt = OrgMinimaKissvmTokensToken_TOKEN_GLOBAL, 0x19, -1, -1, -1, -1 },
    { "TOKEN_OPENBRACKET", "I", .constantValue.asInt = OrgMinimaKissvmTokensToken_TOKEN_OPENBRACKET, 0x19, -1, -1, -1, -1 },
    { "TOKEN_CLOSEBRACKET", "I", .constantValue.asInt = OrgMinimaKissvmTokensToken_TOKEN_CLOSEBRACKET, 0x19, -1, -1, -1, -1 },
    { "TOKEN_TRUE", "I", .constantValue.asInt = OrgMinimaKissvmTokensToken_TOKEN_TRUE, 0x19, -1, -1, -1, -1 },
    { "TOKEN_FALSE", "I", .constantValue.asInt = OrgMinimaKissvmTokensToken_TOKEN_FALSE, 0x19, -1, -1, -1, -1 },
    { "mTokenType_", "I", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "mToken_", "LNSString;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "ILNSString;", "tokenize", "LNSString;", "LOrgMinimaKissvmExceptionsMinimaParseException;", "(Ljava/lang/String;)Ljava/util/List<Lorg/minima/kissvm/tokens/Token;>;", "isNumeric", "isVariable", "main", "[LNSString;", &OrgMinimaKissvmTokensToken_TOKENS_COMMAND, &OrgMinimaKissvmTokensToken_TOKENS_OPERATOR };
  static const J2ObjcClassInfo _OrgMinimaKissvmTokensToken = { "Token", "org.minima.kissvm.tokens", ptrTable, methods, fields, 7, 0x1, 8, 14, -1, -1, -1, -1, -1 };
  return &_OrgMinimaKissvmTokensToken;
}
...
OrgMinimaKissvmTokensToken *new_OrgMinimaKissvmTokensToken_initWithInt_withNSString_(jint zTokenType, NSString *zToken) {
  J2OBJC_NEW_IMPL(OrgMinimaKissvmTokensToken, initWithInt_withNSString_, zTokenType, zToken)
}

OrgMinimaKissvmTokensToken *create_OrgMinimaKissvmTokensToken_initWithInt_withNSString_(jint zTokenType, NSString *zToken) {
...
jboolean OrgMinimaKissvmTokensToken_isNumericWithNSString_(NSString *str) {
  OrgMinimaKissvmTokensToken_initialize();
  return [((NSString *) nil_chk(str)) java_matches:@"-?\\d+(\\.\\d+)?"];
}

jboolean OrgMinimaKissvmTokensToken_isVariableWithNSString_(NSString *str) {
  OrgMinimaKissvmTokensToken_initialize();
  return [((NSString *) nil_chk(str)) java_matches:@"[a-z]*"];
}

void OrgMinimaKissvmTokensToken_mainWithNSStringArray_(IOSObjectArray *zArgs) {
  OrgMinimaKissvmTokensToken_initialize();
  NSString *text = @"asFg";
  [((JavaIoPrintStream *) nil_chk(JreLoadStatic(JavaLangSystem, out))) printlnWithBoolean:[text java_matches:@"[a-z]*"]];
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgMinimaKissvmTokensToken)
