...
import Flower.json.simple.parser.JSONParser;
import Flower.json.simple.parser.ParseException;
...
public class JSONValue {
	 ...
	 * 
	 * @see Flower.json.simple.parser.JSONParser#parse(Reader)
	 ...
	 * Parse JSON text into java object from the input source.
	 * 
	 * @see Flower.json.simple.parser.JSONParser
	 * 
	 * @param in
	 * @return Instance of the following:
	 * 	org.json.simple.JSONObject,
     ...
     * 
     * @see Flower.json.simple.JSONObject#writeJSONString(Map, Writer)
     * @see Flower.json.simple.JSONArray#writeJSONString(List, Writer)
     * 
     * @param value
     * @param writer
     */
	 ...
	 * 
	 * @see Flower.json.simple.JSONObject#toJSONString(Map)
	 * @see Flower.json.simple.JSONArray#toJSONString(List)
	 * 
	 * @param value
