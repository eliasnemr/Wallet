...
import Flower.minima.miniscript.tokens.LexicalTokenizer;
...
public class ExpressionParser {
	...
	private static Expression getBaseUnit(LexicalTokenizer zTokens) throws MinimaParseException{
		...
		}else if(tok.getTokenType() == Token.TOKEN_PARAM) {
			exp = new ParameterExpression(Integer.parseInt(tok.getToken()));
		
		}else if(tok.getTokenType() == Token.TOKEN_GLOBAL) {
			exp = new GlobalExpression(Integer.parseInt(tok.getToken()));
