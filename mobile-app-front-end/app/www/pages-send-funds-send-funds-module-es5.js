...
var SendFundsPage = /** @class */ (function () {
    function SendFundsPage(menu, modalController, myTools, formBuilder, api, balanceService, _contactService, route) {
        this.menu = menu;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.api.sendMessageTransaction(data)];
                    case 1:
                        res = _a.sent();
                        console.log(res);
                        if (res.status) {
                        ...
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.api.sendFunds(data)];
                    case 3:
                        res = _a.sent();
                        console.log(res);
                        if (res.status) {
