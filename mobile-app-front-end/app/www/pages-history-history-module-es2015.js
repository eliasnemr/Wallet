...
let HistoryPage = class HistoryPage {
    ...
    presentHistoryInfo(ev, _name, _addr, _blkNumber, _amnt, _isBlock, _txpowid, _parent, _blockdiff, _date, _state) {
    ...
    // Present history details popover when tapped/clicked
    presentHistoryTokenInfo(ev, _addr, _blkNumber, _amnt, _isBlock, _txpowid, _parent, _blockdiff, _date, _state) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const popover = yield this.popHistoryController.create({
