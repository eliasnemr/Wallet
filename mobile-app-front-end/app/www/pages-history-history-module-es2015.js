...
let HistoryPage = class HistoryPage {
    constructor(historyService, modalController, platform, histData, user, alertCtrl, toastCtrl, config, router) {
 ...
 */
let HistoryData = class HistoryData {
    constructor() {
    }
    load() {
        if (this.data) {
...
let HistoryService = class HistoryService {
    ...
    request(route) {
        const historyObservable = rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"].create(observer => {
            Minima.cmd('history', function (res) {
                observer.next(res);
            });
        });
        let history$ = historyObservable;
        return this.polledHistory$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["timer"])(0, 2000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["concatMap"])(_ => history$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => res));
    }
};
