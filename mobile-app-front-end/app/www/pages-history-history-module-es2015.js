...
let HistoryPage = class HistoryPage {
    constructor(api, historyService, modalController) {
        this.api = api;
    ...
    /** Modals */
    presentModal(_txpowid, _amount, _message, _txnid, _block, _parent, _tokenid, _date, _isBlock, _name) {
    ...
    presentTokenModal(_txpowid, _amount, _message, _txnid, _block, _parent, _tokenid, _date, _isBlock, _name) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const modal = yield this.modalController.create({
