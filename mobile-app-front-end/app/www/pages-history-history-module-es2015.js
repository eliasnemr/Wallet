        ...
        this.api.getHistory().then((res) => {
            if (res.status === true) {
                ...
                res.response.history.forEach((activity) => {
                    ...
                    let transSummary = new _models_t_summary__WEBPACK_IMPORTED_MODULE_1__["T_Summary"](countActivity, Month, Day, Tokenid, "Minima", Amount, 10, Address, blockNumber, isBlock, txpowid, parent, blockdiff, date);
