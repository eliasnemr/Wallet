...
/* harmony import */ var _index_bef2383e_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-bef2383e.js */ "./node_modules/web-social-share/dist/esm/index-bef2383e.js");
...
const WebSocialShare = class {
    ...
    render() {
        return (Object(_index_bef2383e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: this.show ? 'web-social-share web-social-share-open' : 'web-social-share web-social-share-close' }, Object(_index_bef2383e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: 'web-social-share-backdrop', onClick: () => this.hide() }), Object(_index_bef2383e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: 'web-social-share-action-sheet', onClick: () => this.hide() }, Object(_index_bef2383e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: 'web-social-share-action-sheet-container' }, Object(_index_bef2383e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: 'web-social-share-action-sheet-group' }, this.renderTargets())))));
    }
    renderTargets() {
        if (!this.share || !this.share.config) {
            ...
            return (this.share.config.map((config) => Object(_index_bef2383e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "web-social-share-target" }, this.renderButtons(config))));
        }
    }
    renderButtons(share) {
        if (share.facebook) {
    ...
    get el() { return Object(_index_bef2383e_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); }
};
