...
var map = {
	"./components/contacts-modal/contacts-modal.module": [
		"./src/app/components/contacts-modal/contacts-modal.module.ts",
		"components-contacts-modal-contacts-modal-module"
	]
};
...
var routes = [
    { path: 'balance', loadChildren: function () { return Promise.all(/*! import() | pages-balance-balance-module */[__webpack_require__.e("default~pages-balance-balance-module~pages-balance-view-tokens-view-tokens-module~pages-contacts-con~f2bc9dac"), __webpack_require__.e("pages-balance-balance-module")]).then(__webpack_require__.bind(null, /*! ./pages/balance/balance.module */ "./src/app/pages/balance/balance.module.ts")).then(function (m) { return m.BalancePageModule; }); } },
    ...
    { path: 'view-tokens', loadChildren: function () { return Promise.all(/*! import() | pages-balance-view-tokens-view-tokens-module */[__webpack_require__.e("default~pages-balance-balance-module~pages-balance-view-tokens-view-tokens-module~pages-contacts-con~f2bc9dac"), __webpack_require__.e("default~pages-balance-view-tokens-view-tokens-module~view-tokens-view-tokens-module")]).then(__webpack_require__.bind(null, /*! ./pages/balance/view-tokens/view-tokens.module */ "./src/app/pages/balance/view-tokens/view-tokens.module.ts")).then(function (m) { return m.ViewTokensPageModule; }); } },
    { path: 'view-tokens/:id', loadChildren: function () { return Promise.all(/*! import() | pages-balance-view-tokens-view-tokens-module */[__webpack_require__.e("default~pages-balance-balance-module~pages-balance-view-tokens-view-tokens-module~pages-contacts-con~f2bc9dac"), __webpack_require__.e("default~pages-balance-view-tokens-view-tokens-module~view-tokens-view-tokens-module")]).then(__webpack_require__.bind(null, /*! ./pages/balance/view-tokens/view-tokens.module */ "./src/app/pages/balance/view-tokens/view-tokens.module.ts"))
            .then(function (m) { return m.ViewTokensPageModule; }); } },
    { path: 'contacts', loadChildren: function () { return Promise.all(/*! import() | pages-contacts-contacts-module */[__webpack_require__.e("default~pages-balance-balance-module~pages-balance-view-tokens-view-tokens-module~pages-contacts-con~f2bc9dac"), __webpack_require__.e("pages-contacts-contacts-module")]).then(__webpack_require__.bind(null, /*! ./pages/contacts/contacts.module */ "./src/app/pages/contacts/contacts.module.ts")).then(function (m) { return m.ContactsPageModule; }); } },
    { path: '**', loadChildren: function () { return Promise.all(/*! import() | pages-balance-balance-module */[__webpack_require__.e("default~pages-balance-balance-module~pages-balance-view-tokens-view-tokens-module~pages-contacts-con~f2bc9dac"), __webpack_require__.e("pages-balance-balance-module")]).then(__webpack_require__.bind(null, /*! ./pages/balance/balance.module */ "./src/app/pages/balance/balance.module.ts")).then(function (m) { return m.BalancePageModule; }); } },
    { path: '', redirectTo: 'balance', pathMatch: 'full' },
    { path: 'contacts-modal', loadChildren: './components/contacts-modal/contacts-modal.module#ContactsModalPageModule' },
];
...
module.exports = "ion-menu {\n  --background: var(--ion-m-background);\n}\n\nion-menu ion-header {\n  --background: var(--ion-m-background);\n}\n\nion-menu ion-header ion-toolbar {\n  --background: var(--ion-m-background);\n}\n\nion-menu ion-content {\n  --background: var(--ion-m-background);\n}\n\nion-item {\n  font-family: manrope-bold;\n  padding-left: 1%;\n  color: var(--minima-text);\n}\n\nion-icon {\n  color: var(--ion-color-tertiary);\n}\n\n/** Desktop Version */\n\n@media only screen and (min-width: 992px) {\n  .splitpane {\n    border: 1px solid #1E3346;\n    left: 12%;\n    right: 12%;\n    top: 6%;\n    bottom: 6%;\n  }\n\n  ion-app {\n    background-color: #031D32;\n  }\n}\n\n/*\n * Material Design Menu\n*/\n\nion-menu.md ion-list {\n  padding: 0px 0;\n}\n\nion-menu.md ion-item {\n  --padding-start: 18px;\n  margin-right: 10px;\n  border-radius: 0 50px 50px 0;\n}\n\nion-menu.md ion-item.selected {\n  color: var(--ion-color-primary);\n}\n\nion-menu.md ion-item.selected ion-icon {\n  color: var(--ion-color-primary);\n}\n\n/*\n  * iOS Design Menu\n*/\n\nion-menu.ios ion-list {\n  padding: 0px 0 0;\n  margin-bottom: 10px;\n}\n\nion-menu.ios ion-item {\n  --padding-start: 16px;\n  --min-height: 50px;\n}\n\nion-toolbar {\n  --background: var(--ion-m-background);\n}\n\nion-footer ion-item, ion-footer ion-col, ion-footer {\n  --background: #91919D !important;\n  background: #91919D;\n}\n\nion-footer ion-item span {\n  color: #FAFAFF;\n}\n\nion-toggle {\n  --handle-background-checked: var(--ion-m-background);\n  --background-checked: #F0F0F9;\n}\n\n/** Minima Icon */\n\n#icon .st0 {\n  fill: var(--st0);\n}\n\n#icon .st1 {\n  fill: var(--st1);\n}\n\n#icon .st2 {\n  fill: var(--st2);\n}\n\n#icon .st3 {\n  fill: var(--st3);\n}\n\n#icon .st4 {\n  fill: var(--st4);\n}\n\n#icon .st5 {\n  fill: var(--st5);\n}\n\n#icon .st6 {\n  fill: var(--st6);\n}\n\n#icon-M, #icon-I, #icon-N, #icon-I, #icon-M, #icon-A {\n  fill: var(--minima-icon-word);\n}\n\n@media only screen and (max-width: 650px) {\n  #icon {\n    width: 120px;\n  }\n}\n\n@media only screen and (min-width: 650px) {\n  #icon {\n    width: 145px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _service_contacts_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./service/contacts.service */ "./src/app/service/contacts.service.ts");
...
/* harmony import */ var _service_userconfig_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./service/userconfig.service */ "./src/app/service/userconfig.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(status, api, userConfigService, contactsService, platform, toastCtrl, historyService, ngZone) {
        this.status = status;
        this.api = api;
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            minima__WEBPACK_IMPORTED_MODULE_8__["Minima"].init(function (msg) {
                if (msg.event === 'connected') {
                    _this.api.updatedBalance.next(minima__WEBPACK_IMPORTED_MODULE_8__["Minima"].balance);
                }
                    ...
                    minima__WEBPACK_IMPORTED_MODULE_8__["Minima"].cmd('status full', function (res) {
    ...
    AppComponent.ctorParameters = function () { return [
        ...
        { type: _service_userconfig_service__WEBPACK_IMPORTED_MODULE_5__["UserConfigService"] },
        { type: _service_contacts_service__WEBPACK_IMPORTED_MODULE_1__["ContactService"] },
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_status_service__WEBPACK_IMPORTED_MODULE_4__["StatusService"],
            ...
            _service_userconfig_service__WEBPACK_IMPORTED_MODULE_5__["UserConfigService"],
            _service_contacts_service__WEBPACK_IMPORTED_MODULE_1__["ContactService"],
...
/* harmony import */ var _components_pop_filter_pop_filter_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/pop-filter/pop-filter.component */ "./src/app/components/pop-filter/pop-filter.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _components_pop_filter_pop_filter_component__WEBPACK_IMPORTED_MODULE_16__["PopFilterComponent"],
                _components_contacts_modal_contacts_modal_page__WEBPACK_IMPORTED_MODULE_1__["ContactsModalPage"]
            ],
            entryComponents: [_components_pop_settings_pop_settings_component__WEBPACK_IMPORTED_MODULE_15__["PopSettingsComponent"], _components_pop_filter_pop_filter_component__WEBPACK_IMPORTED_MODULE_16__["PopFilterComponent"], _components_pop_term_pop_term_component__WEBPACK_IMPORTED_MODULE_14__["PopTermComponent"], _components_contacts_modal_contacts_modal_page__WEBPACK_IMPORTED_MODULE_1__["ContactsModalPage"]],
            imports: [
...
module.exports = "ion-card-header {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n          justify-content: center;\n}\n\nion-title {\n  font-size: 1rem;\n  font-family: manrope-bold;\n  color: var(--ion-color-tertiary);\n}\n\nion-input {\n  color: #000;\n  line-height: 16px;\n  background-color: #ffffff;\n}\n\nion-item ion-label {\n  white-space: normal;\n  word-break: normal;\n}\n\nion-button.header {\n  text-transform: none;\n  color: var(--ion-color-tertiary);\n}\n\nion-button {\n  width: 100%;\n  height: 58px;\n  text-align: center;\n  text-transform: none;\n  font-family: manrope-bold;\n  color: var(--ion-color-tertiary) !important;\n}\n\nion-header ion-toolbar ion-buttons ion-button {\n  color: var(--ion-color-primary) !important;\n}\n\nion-header ion-toolbar ion-buttons ion-button:hover {\n  --background-hover: none;\n  --color: var(--ion-color-secondary);\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ContactsModalPage = /** @class */ (function () {
    function ContactsModalPage(modalCtrl, contactService, formBuilder) {
    ...
    ContactsModalPage.prototype.ngOnInit = function () {
        ...
        this.contactForm.valueChanges.subscribe(function (val) {
            console.log(val);
        });
    };
    ...
    ContactsModalPage.prototype.addContact = function (address, name, description, avatar) {
    ...
    ContactsModalPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], src_app_service_contacts_service__WEBPACK_IMPORTED_MODULE_1__["ContactService"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"]])
    ], ContactsModalPage);
...
var ContactService = /** @class */ (function () {
    function ContactService() {
        this.data = new rxjs__WEBPACK_IMPORTED_MODULE_1__["ReplaySubject"]();
        this.qContacts = 'CREATE TABLE IF NOT EXISTS contacts (' +
            'address varchar(255) PRIMARY KEY,' +
            'name varchar(255),' +
            'description varchar(255),' +
            'avatar varchar(255))';
        minima__WEBPACK_IMPORTED_MODULE_2__["Minima"].sql(this.qContacts + ';SELECT * FROM contacts', function (res) {
    ...
    ContactService.prototype.loadContacts = function () {
        ...
        minima__WEBPACK_IMPORTED_MODULE_2__["Minima"].sql(this.qContacts, function (res) {
            if (res.status) {
                console.log(res);
            }
        });
    ...
    UserConfigService.prototype.createUserConfig = function (defaultConfig) {
        ...
        minima__WEBPACK_IMPORTED_MODULE_2__["Minima"].file.load('UserConfig.txt', function (res) {
            ...
            if (!res.success && !res.exists) {
                ...
                minima__WEBPACK_IMPORTED_MODULE_2__["Minima"].file.save(JSON.stringify(data), 'UserConfig.txt', function (res) {
                    if (res.success) {
