...
var BalancePage = /** @class */ (function () {
    function BalancePage(service, alertController, popoverController, balanceService) {
    ...
    BalancePage.prototype.giveMe50 = function () {
        var _this = this;
        this.service.giveMe50().then(function (res) {
            if (res.status === true) {
    ...
    BalancePage.prototype.pullInTokens = function () {
        var _this = this;
        // get our balance
        this.service.getBalance().then(function (res) {
            console.log(res);
            var countTokens = 0;
            var tempConfirmed = 0;
            var tempUnConfirmed = '';
            ...
            _this.http.get(apiUrl, { responseType: 'json' })
                ...
                for (var key in responseData) {
                    if (responseData.hasOwnProperty(key)) {
                        tokenArr.push(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, responseData[key], { id: key }));
                    }
                }
                return responseData;
            }))
