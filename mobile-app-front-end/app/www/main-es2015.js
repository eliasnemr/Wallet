...
const routes = [
    ...
    { path: 'view-tokens/:id', loadChildren: () => __webpack_require__.e(/*! import() | pages-balance-view-tokens-view-tokens-module */ "view-tokens-view-tokens-module").then(__webpack_require__.bind(null, /*! ./pages/balance/view-tokens/view-tokens.module */ "./src/app/pages/balance/view-tokens/view-tokens.module.ts")).then(m => m.ViewTokensPageModule) },
];
...
let AppComponent = class AppComponent {
    constructor(platform, storage, api, toastCtrl) {
