...
const ItemOptions = class {
    ...
    render() {
        const mode = Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this);
        const isEnd = Object(_helpers_e0fdb9d0_js__WEBPACK_IMPORTED_MODULE_2__["i"])(this.side);
...
const ItemSliding = class {
    ...
    async updateOptions() {
        ...
        for (let i = 0; i < options.length; i++) {
            ...
            const side = Object(_helpers_e0fdb9d0_js__WEBPACK_IMPORTED_MODULE_2__["i"])(option.side) ? 'end' : 'start';
            if (side === 'start') {
