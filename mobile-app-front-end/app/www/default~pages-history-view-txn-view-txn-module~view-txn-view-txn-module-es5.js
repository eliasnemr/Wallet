...
var ViewTXNPage = /** @class */ (function () {
    function ViewTXNPage(route, api, _historyService, myTools) {
        this.route = route;
        this.api = api;
    ...
    ViewTXNPage.prototype.ionViewWillEnter = function () {
        ...
        this._historyService
            ...
            if (_this.myTxn.txpow.body.txn.state && _this.myTxn.txpow.body.txn.state[0] && _this.myTxn.txpow.body.txn.state[0].data === '[01000100]') {
                ...
                _this.message = _this.message.substring(1, _this.message.length - 1);
            }
            if (_this.myTxn.txpow.body.txn.tokengen) {
