...
var BalancePage = /** @class */ (function () {
    ...
    BalancePage.prototype.pullInTokens = function () {
        ...
        this.api.getBalance().then(function (res) {
            ...
            var theBalanceExists = res.response.balance;
            var theBalanceLength = res.response.balance.length;
            var countTokens = 0;
            res.response.balance.forEach(function (element) {
                ...
                if (element.tokenid === _this.MINIMA_TOKEN_ID) {
                    ...
                    var temp = new _tokens__WEBPACK_IMPORTED_MODULE_5__["Tokens"](element.tokenid, element.token, tempConfirmed, tempUnConfirmed, element.total);
