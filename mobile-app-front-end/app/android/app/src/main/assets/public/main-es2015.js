...
let PopHistoryTokenComponent = class PopHistoryTokenComponent {
    constructor(navParams, clipboard) {
...
PopHistoryTokenComponent.ctorParameters = () => [
...
let PopHistoryComponent = class PopHistoryComponent {
    constructor(navParams, clipboard) {
        this.navParams = navParams;
        this.clipboard = clipboard;
...
PopHistoryComponent.ctorParameters = () => [
