...
import Flower.minima.utils.SuperBlockLevels;
...
public class TxPOW implements Streamable {
	...
	public JSONObject toJSON() {
		...
		txpow.put("nonce", mNonce);
		txpow.put("mmr", mMMRRoot.toString());
		
		txpow.put("timemilli", mTimeMilli);
	...
	public void readDataStream(DataInputStream zIn) throws IOException {
		...
		for(int i=0;i<len;i++) {
//			MiniData32 in = new MiniData32();
//			in.readDataStream(zIn);
