...
public class Main extends MessageProcessor {
	...
	public String mAutoHost = "ec2-35-176-153-40.eu-west-2.compute.amazonaws.com";
	public int mAutoPort    = 9000;
	 ...
	 * @param zGenesis
	 */
	public Main(int zPort, boolean zGenesis, String zHomeFolder) {
		super("MAIN     ");
		 ...
		 */
		SimpleLogger.log("**********************************************");
		SimpleLogger.log("*  __  __  ____  _  _  ____  __  __    __    *");
		SimpleLogger.log("* (  \\/  )(_  _)( \\( )(_  _)(  \\/  )  /__\\   *");
		SimpleLogger.log("*  )    (  _)(_  )  (  _)(_  )    (  /(__)\\  *");
		SimpleLogger.log("* (_/\\/\\_)(____)(_)\\_)(____)(_/\\/\\_)(__)(__) *");
		SimpleLogger.log("*                                            *");
		SimpleLogger.log("**********************************************");
...
//		mSim.setLOG(zTraceON);
	...
	protected void processMessage(Message zMessage) throws Exception {
		...
		if ( zMessage.isMessageType(SYSTEM_STARTUP) ) {
			...
			//Start the network..	
			Message netstart = new Message(NetworkHandler.NETWORK_STARTUP).addInt("port", mPort);
...
//				SimpleLogger.log("Connecting to MainNet!");
				
//				Message connect  = new Message(NetworkHandler.NETWORK_CONNECT)
//						.addInt("port", 9000)
//						.addString("host", "127.0.0.1");
			...
			//All done..
			SimpleLogger.log("Minima Stopped. Bye Bye..");
			...
			//Unknown Message..
			SimpleLogger.log("Unknown Message sent to main handler "+zMessage);
		}
	}
