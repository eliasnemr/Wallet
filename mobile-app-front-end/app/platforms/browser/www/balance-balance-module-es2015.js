...
let BalancePage = class BalancePage {
    constructor(api, alertController, popoverController, balanceService, changeDetection) {
        this.api = api;
        ...
        this.api.getBalance().then((res) => {
            ...
            res.response.balance.forEach(element => {
                ...
                if (element.tokenid === this.MINIMA_TOKEN_ID) {
                    ...
                    let temp = new _MiniObjects_tokens__WEBPACK_IMPORTED_MODULE_4__["Tokens"](element.tokenid, element.token, tempConfirmed, tempUnConfirmed, element.total);
