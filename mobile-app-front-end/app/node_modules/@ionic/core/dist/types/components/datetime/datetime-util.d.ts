 ...
 * no date given
 */
export declare const getDateValue: (date: DatetimeData, format: string) => string | number;
...
export declare const parseDate: (val: string | null | undefined) => DatetimeData | undefined;
/**
...
export declare const updateDate: (existingData: DatetimeData, newData: any) => boolean;
 ...
 */
export declare const convertToArrayOfStrings: (input: string | string[] | null | undefined, type: string) => string[] | undefined;
/**
 * Use to convert a string of comma separated numbers or
 * an array of numbers, and clean up any user input
 */
export declare const convertToArrayOfNumbers: (input: string | number | any[], type: string) => number[];
